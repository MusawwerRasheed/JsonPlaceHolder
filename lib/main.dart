...
import 'package:jsonplaceholder/Presentation/Widget/Products/Posts_screen.dart';
...
class MyApp extends StatelessWidget {
  final PostRepository repository = PostRepository(); // Create an instance of the repository
